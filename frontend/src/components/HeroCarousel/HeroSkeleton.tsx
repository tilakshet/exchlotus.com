export function HeroSkeleton({ compact = false }: { compact?: boolean } = {}) {
  return (
    <section className={`w-full px-4 sm:px-6 lg:px-8 ${compact ? "" : "pt-40"}`} aria-label="Loading hero banners">
      <div className="relative h-[420px] overflow-hidden rounded-[24px] border border-white/[.08] bg-[#000000] shadow-[0_32px_90px_-52px_rgba(0,0,0,.9)] md:h-[520px]">
        <div className="absolute inset-0 animate-pulse bg-[linear-gradient(110deg,#000000_0%,#131C2A_38%,#021A2A_48%,#131C2A_58%,#000000_100%)] bg-[length:220%_100%]" />
        <div className="absolute inset-x-0 bottom-0 top-0 bg-[radial-gradient(circle_at_72%_42%,rgba(59,141,17,.18),transparent_32%)]" />
